        ...
        <div class="p-6 text-gray-900">
            ...
            <form action="{{ route('admin.tarif.update', $tarif) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="time" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai', $tarif->jam_mulai) }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                    @error('jam_mulai')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="time" name="jam_selesai" id="jam_selesai" value="{{ old('jam_selesai', $tarif->jam_selesai) }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                    @error('jam_selesai')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga', $tarif->harga) }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                    @error('harga')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
