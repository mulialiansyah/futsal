...
<div class="flex min-h-screen bg-neutral-50 flex-col">

    <!-- TOPBAR -->
    <header class="bg-white border-b border-neutral-200">
        <div class="px-4 py-4 flex items-center justify-between max-w-6xl mx-auto">
            <div class="flex items-center gap-2">
                <span class="w-2.5 h-2.5 rounded-full bg-red-500"></span>
                <span class="font-display text-xl">FutsalKIte</span>
            </div>
            <div class="flex items-center gap-3">
                <button class="relative w-10 h-10 rounded-full bg-neutral-50 border border-neutral-200 flex items-center justify-center">
                ...
                <div class="flex items-center gap-3 px-3 py-2 rounded-xl bg-neutral-100">
                    <div class="w-8 h-8 rounded-full bg-sky-200 flex items-center justify-center text-base">👨</div>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="text-neutral-400 hover:text-red-500 transition" aria-label="Keluar">
    ...
    <main class="flex-1 min-w-0 flex flex-col">
        ...
        <div class="flex-1 px-4 py-6 pb-36">
            <div class="max-w-6xl mx-auto">
                ...
                <p class="text-sm text-neutral-500 mb-6">Kelola lapangan futsal kamu hari ini</p>
        ...
        <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 z-50 px-4 py-3">
            <div class="max-w-md mx-auto flex items-center justify-around">
                <a href="{{ route('admin.dashboard') }}" 
                   class="flex flex-col items-center gap-1 {{ request()->routeIs('admin.dashboard') ? 'text-yellow-600' : 'text-neutral-400' }}">
                    <div class="{{ request()->routeIs('admin.dashboard') ? 'bg-yellow-100' : '' }} p-2 rounded-xl transition-all">
                ...
                <a href="{{ route('admin.lapangan.index') }}" 
                   class="flex flex-col items-center gap-1 {{ request()->routeIs('admin.lapangan.*') ? 'text-yellow-600' : 'text-neutral-400' }}">
                    <div class="{{ request()->routeIs('admin.lapangan.*') ? 'bg-yellow-100' : '' }} p-2 rounded-xl transition-all">
                ...
                <a href="{{ route('admin.tarif.index') }}" 
                   class="flex flex-col items-center gap-1 {{ request()->routeIs('admin.tarif.*') ? 'text-yellow-600' : 'text-neutral-400' }}">
                    <div class="{{ request()->routeIs('admin.tarif.*') ? 'bg-yellow-100' : '' }} p-2 rounded-xl transition-all">
                ...
                <a href="{{ route('admin.booking.index') }}" 
                   class="flex flex-col items-center gap-1 {{ request()->routeIs('admin.booking.*') ? 'text-yellow-600' : 'text-neutral-400' }} relative">
                    <div class="{{ request()->routeIs('admin.booking.*') ? 'bg-yellow-100' : '' }} p-2 rounded-xl transition-all">
                ...
                <a href="{{ route('admin.laporan.index') }}" 
                   class="flex flex-col items-center gap-1 {{ request()->routeIs('admin.laporan.*') ? 'text-yellow-600' : 'text-neutral-400' }}">
                    <div class="{{ request()->routeIs('admin.laporan.*') ? 'bg-yellow-100' : '' }} p-2 rounded-xl transition-all">
                ...
                <a href="{{ route('admin.pembayaran.index') }}" 
                   class="flex flex-col items-center gap-1 {{ request()->routeIs('admin.pembayaran.*') ? 'text-yellow-600' : 'text-neutral-400' }}">
                    <div class="{{ request()->routeIs('admin.pembayaran.*') ? 'bg-yellow-100' : '' }} p-2 rounded-xl transition-all">
